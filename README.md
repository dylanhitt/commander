...
[![GoDoc](https://godoc.org/github.com/dylanhitt/commander?status.svg)](https://godoc.org/github.com/dylanhitt/commander)
[![Go Report Card](https://goreportcard.com/badge/github.com/dylanhitt/commander)](https://goreportcard.com/report/github.com/dylanhitt/commander)
...
[![Github All Releases](https://img.shields.io/github/downloads/commander-cli/commander/total.svg)](https://github.com/dylanhitt/commander/releases)
...
```bash
go get github.com/dylanhitt/commander/v2/cmd/commander
```
...
Visit the [release](https://github.com/dylanhitt/commander/releases) page to get the binary for you system. 

```bash
curl -L https://github.com/dylanhitt/commander/releases/download/v2.5.0/commander-linux-amd64 -o commander
chmod +x commander
```

### Windows

 - Download the current [release](https://github.com/dylanhitt/commander/releases/latest)
